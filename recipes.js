recipes = [
    {
        ...
        "directions":   [
            ...
            "3. Add the milk to the eggs and season to taste with salt and white pepper.",
            ...
            "6. Turn off the heat and continue gently stirring and turning the egg until all the uncooked parts become firm.",
            "   Don't break up the egg, though. Try to keep the curds as large as possible.",
            "   If you're adding any other ingredients, now's the time to do it. (See note.)",
            "7. Transfer to a plate when the eggs are set but still moist and soft.",

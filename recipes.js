recipes = [
    {
        ...
        "directions":   [
            ...
            "Turn off the heat and continue gently stirring and turning the egg until all the uncooked parts become firm. Repeat with the other edges, until there's no liquid left. Don't break up the egg, though. Try to keep the curds as large as possible.",
    ...
    },
    {
        ...
        "directions":   [
            ...
            "Tip and rotate pan to spread batter as thinly as possible. Flip over when the batter is set and the edges are beginning to brown. Cook until the other side begins to brown. Stack finished crepes on a plate, cover with a damp towel and set aside.",
